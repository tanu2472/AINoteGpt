...
if (c2w_ai_line.isEmpty()) { c2w_ai_area.appendText("\n");
continue;
}
if (c2w_ai_line.endsWith(":") && !c2w_ai_line.contains("*")) {
c2w_ai_area.appendText(c2w_ai_line + "\n");
c2w_ai_area.setStyle(c2w_ai_area.getLength() - 
c2w_ai_line.length() - 1, c2w_ai_area.getLength(),"-fx-font-weight: bold; -fx-font-size: 14px;-fx-fill:rgb(255, 255, 255);");
continue;
}
...
c2w_ai_area.appendText(c2w_ai_line + "\n");
c2w_ai_area.setStyle(c2w_ai_area.getLength() - c2w_ai_line.length() - 1, c2w_ai_area.getLength(),
