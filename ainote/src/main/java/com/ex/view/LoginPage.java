...
import com.ex.controller.UserController; 
...
c2w_ai_loginButton.setStyle("-fx-pref-width: 70;-fx-min-height: 30;-fx-background-radius:15; -fx-background-color : #2196F3; -fx-text-fill:#FFFFFFF");
...
Class.forName("com.ex.configuration.FirebaseInitialization");
