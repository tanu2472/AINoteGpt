...
import com.ex.controller.AiApiController; 
import com.ex.controller.FormatController; 
import com.ex.controller.NotesController; 
import com.ex.model.Note; 
import com.ex.utilities.SnackBar;
...
private HtmlRenderer c2w_ai_renderer = HtmlRenderer.builder().build();
...
String c2w_ai_plainText = 
c2w_ai_renderer.render(c2w_ai_markdownParser.parse(c2w_ai_markdown));
